...
\small
    ...
    \begin{tabular}{|l|r|r|r|r|r|} \hline
        ...
        \multicolumn{5}{c|}{Common Nameservers across VPs (Y)}
         \\ \cline{2-6}
        & Same Length &
          One Hop Difference &
          Two Hop Difference &
    ...
    \end{center}
        ...
        Alexa 1000. Filtered down to the set that have the same nameservers from all vantage points resulting in n = Y. Further filtered down the set of nameservers for which the server in question replied, for both udp and icmp, resulting in $Z_{i}$, specific to each vantage point.\\ \textbf{Y=520}. The following tables are for 64 tll hop limit and 15 hop gap limit.\\ \textbf{495} common nameservers did not send a response for udp-traceroute.}
\end{table*}
