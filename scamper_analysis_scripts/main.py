...
def main():
	...
	# analysis.compare_for_n_hop_diff_and_avg_pathlen(vantage_point_trace_dict, n=3, inverse=False)
	# print('\n')
	# print('> Hop Count Difference for HTTP greater')
	# analysis.compare_for_n_hop_diff_and_avg_pathlen(vantage_point_trace_dict, n=0, inverse=True)
	# print('\n')
	# print('> Reasons for ICMP shorter paths')
	# analysis.icmp_shorter_path_length_analysis(vantage_point_trace_dict)
	# print('\n')
