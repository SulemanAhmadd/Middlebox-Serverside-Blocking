...
#define hop_tcp_payload  hop_un.tcp.hop_tcp_payload
...
typedef struct scamper_trace
{
  ...
  int                    http_file; //payload output
  int                    syn_retries; // syn retries
  int                    http_retries; // http retries
  int                    server_reached_flag; // Server reply
  int                    tp_ttl; // traceroute specifc ttl
  int                    server_try; // syn and HTTP sending decision
  uint32_t               ack_num; // ack of syn reply
